...
$\bar r_Y$ direction. Sweeping $\bar r_Y$ and solving for $\bar r_X$
cannot draw it, because along that arm the answer is $+\infty$: every
$\bar r_X$ leaves the conclusion standing.
...
Both arms again, with the vertical one now near
`r sprintf("%.2f", abs(s3$breakdown))` instead of 0.80 -- the inward
shift the paper describes.
...
to the stylized illustration in the
[MP examples vignette](../articles/mp2022-stylized.html).
...
knitr::kable(data.frame(
  ...
  Status = c("reproduced", "reproduced", "not reproducible",
             "reproduced", "reproduced", "structure only",
             "structure only", "not reproducible", "out of scope",
             "out of scope", "out of scope"),
  Reason = c(
    "matches on both specifications; crossings 0.8036 / 0.9584",
    "both arms match; the horizontal one is drawn in the rybar direction",
    ...
    "matches, shifted inward as in the paper",
...
distributed with the package -- the full BFG outcome set, or the Satyanath et al. microdata -- or, in
