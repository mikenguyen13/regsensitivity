...
boundary rather than a disagreement: the computed values are
`r sprintf("%.5f", tbl3$R2[tbl3$variable == "Average temperature"])` and
`r sprintf("%.5f", tbl3$R2[tbl3$variable == "Average rainfall"])`, both
within half a unit of the last printed digit.
