...
Masten and Poirier (2026) show that the $\delta$ at which $\beta$ reaches
*zero* and the $\delta$ at which its *sign* can flip are different
numbers, and the second is often far smaller.
...
* **Mixing up the two Oster breakdown points.** The one that reaches zero
  is not the one that flips the sign (Case 8).
