...
{\centering \includegraphics[width=0.85\textwidth]{figures/api-bounds-plot-1} 

}

\caption[Estimated identified set for the long-regression coefficient as a function of rxbar, holding cbar at 0.1]{Estimated identified set for the long-regression coefficient as a function of rxbar, holding cbar at 0.1. The shaded band is the identified set; it widens continuously from the point beta-med at rxbar = 0 and diverges at the finiteness threshold. The horizontal line marks the hypothesis value zero, and the breakdown point is where the lower bound crosses it.}\label{fig:api-bounds-plot}
\end{figure}
\end{Schunk}
...
{\centering \includegraphics[width=0.85\textwidth]{figures/api-breakdown-plot-1} 
...
$80.4$\%, which exceeds
$9$ of the
$10$ calibration values. Only \code{ave_gyi} and
...
$0.522$, still exceeds all but two of the $\rho_k$
...
{\centering \includegraphics[width=0.85\textwidth]{figures/api-frontier-plot-1} 
...
The bootstrap interval, $[0.437,
0.994]$ over $R = 199$ i.i.d.\ replicates, does
...
$n$ & Coverage (\%) & Bias & SD & Mean CI width \\ 
  \midrule
500 & 90.4 & -0.0053 & 0.0294 & 0.1113 \\ 
  1000 & 92.0 & -0.0030 & 0.0208 & 0.0796 \\ 
  4000 & 95.2 & 0.0001 & 0.0097 & 0.0395 \\ 
   \bottomrule
\end{tabular}
