...
- [`bfg2020`](https://mikenguyen13.github.io/regsensitivity/reference/bfg2020.md)
  : Bazzi, Fiszbein and Gebresilasse (2020) "Frontier Culture"
  replication data

## Package

- [`regsensitivity-package`](https://mikenguyen13.github.io/regsensitivity/reference/regsensitivity-package.md)
